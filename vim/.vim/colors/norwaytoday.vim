...
if has("gui_running")
  ...
  "rubyComment
  highlight Comment                   guifg=IndianRed gui=italic
  highlight PreProc                   guifg=IndianRed gui=italic

  "Todo, like NOTE
  highlight Todo                      guifg=IndianRed guibg=NONE gui=italic
  ...
  "rubyFunction
  highlight Function                  guifg=#7FAD95 gui=italic
