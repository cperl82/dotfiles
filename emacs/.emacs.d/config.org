...
- .dotfiles/emacs/.emacs.d/init-lisp/init-paren.el
- .dotfiles/emacs/.emacs.d/init-lisp/init-winner.el
...
#+begin_src emacs-lisp :tangle init-lisp/init-paren.el
  (use-package paren
    :defer t
    :custom
    (show-paren-delay 0)
...
#+begin_src emacs-lisp :tangle init-lisp/init-winner.el
  (use-package winner
    :demand t
    :config
    (winner-mode))
