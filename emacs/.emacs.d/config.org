...
#+begin_src emacs-lisp :var in-a-tmp-dir='nil :results value verbatim
  ;;; -*- lexical-binding: t; -*-
...
#+call: emacs-config-generate-and-run(in-a-tmp-dir='nil)
...
#+call: emacs-config-generate-and-run(in-a-tmp-dir='t)
