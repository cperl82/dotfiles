...
- .dotfiles/emacs/.emacs.d/init-lisp/init-consult.el
- .dotfiles/emacs/.emacs.d/init-lisp/init-dired.el
- .dotfiles/emacs/.emacs.d/init-lisp/init-doom-modeline.el
- .dotfiles/emacs/.emacs.d/init-lisp/init-emacs.el
- .dotfiles/emacs/.emacs.d/init-lisp/init-escreen.el
- .dotfiles/emacs/.emacs.d/init-lisp/init-expand-region.el
- .dotfiles/emacs/.emacs.d/init-lisp/init-general.el
- .dotfiles/emacs/.emacs.d/init-lisp/init-helpful.el
- .dotfiles/emacs/.emacs.d/init-lisp/init-hippie-exp.el
- .dotfiles/emacs/.emacs.d/init-lisp/init-ibuffer.el
- .dotfiles/emacs/.emacs.d/init-lisp/init-isearch.el
- .dotfiles/emacs/.emacs.d/init-lisp/init-kdl.el
- .dotfiles/emacs/.emacs.d/init-lisp/init-lisp.el
- .dotfiles/emacs/.emacs.d/init-lisp/init-local-overrides.el
- .dotfiles/emacs/.emacs.d/init-lisp/init-meow.el
...
- .dotfiles/emacs/.emacs.d/init-lisp/init-swiper-ivy-counsel.el
- .dotfiles/emacs/.emacs.d/init-lisp/init-theme-modus.el
- .dotfiles/emacs/.emacs.d/init-lisp/init-theme-standard.el
- .dotfiles/emacs/.emacs.d/init-lisp/init-theme-zenburn.el
- .dotfiles/emacs/.emacs.d/init-lisp/init-theme.el
...
- ~copy-region-blink-predicate~
  ...
  This function (or symbol declaring what you want) is used to decide if the region should "blink" after invoking something like ~kill-ring-save~. It defaults to ~region-indistinguishable-p~, which tries to decide if the region can be visually distinguished from the background, and if it determines it cannot, then it says that yes, we should blink.

  I find this quite annoying as with my default theme zenburn, the region is easily distinguishable, but ~region-indistinguishable-p~ thinks it's not, and so when invoking ~kill-ring-save~ or ~meow-save~, there is an unecessary delay while it shows my what I just saved.
...
#+begin_src emacs-lisp :tangle init-lisp/init-isearch.el
  (use-package isearch
    :straight nil
    :demand t
    :custom
...
#+begin_src emacs-lisp :tangle init-lisp/init-ibuffer.el
  (use-package ibuffer
    :straight nil
    :defer t
    :bind
...
I'm pretty confident I can replace all of this with some light tweaks to ~tab-bar-mode~ (e.g. turn off the tab bar, make an easy way to show the current tabs in the echo area, etc). And, perhaps even the echo area bit has already been tackled by someone else, see [[https://github.com/fritzgrabo/tab-bar-echo-area][tab-bar-echo-area]].

I'm starting to play around with this in [[id:ff173306-b2d8-4a86-987c-6269216b97c7][Tab Bar Mode]].
...
:PROPERTIES:
:ID:       ff173306-b2d8-4a86-987c-6269216b97c7
:END:
...
#+begin_src emacs-lisp :tangle init-lisp/init-tab-bar.el
  (use-package tab-bar
    :straight nil
    :defer t
    :custom
...
#+begin_src emacs-lisp :tangle init-lisp/init-helpful.el
  (use-package helpful
    :straight t
    :defer t)
#+end_src
...
#+begin_src emacs-lisp :tangle init-lisp/init-expand-region.el
...
** COMMENT Evil, Undo-tree, Evil-collection, Evil-surround
...
#+begin_src emacs-lisp :tangle init-lisp/init-meow.el
  (use-package meow
    :straight t
    :demand t
    :preface
...
** Consult, Vertico, Embark, Orderless, Marginalia

#+begin_src emacs-lisp :tangle init.el :padline no
  (load "init-consult")
#+end_src

#+begin_src emacs-lisp :tangle init-lisp/init-consult.el
  (use-package consult
    :straight t
    :defer t
    :bind
...
#+begin_src emacs-lisp :tangle init-lisp/init-swiper-ivy-counsel.el
  (use-package swiper
    :straight t
    :demand t)
...
#+begin_src emacs-lisp :tangle init-lisp/init-doom-modeline.el
...
#+begin_src emacs-lisp :tangle init-lisp/init-theme-zenburn.el
...
#+begin_src emacs-lisp :tangle init-lisp/init-theme-modus.el
...
Something isn't quite right with this as not all the expected commands are autoloaded, e.g. ~standard-themes-select~. I think it might have something to do with these depending on modus-themes, but I'm not entirely sure.

#+begin_src emacs-lisp :tangle init.el :padline no
  (load "init-theme-standard")
#+end_src

#+begin_src emacs-lisp :tangle init-lisp/init-theme-standard.el
...
#+begin_src emacs-lisp :tangle init-lisp/init-theme.el
