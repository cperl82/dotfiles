...
** Escreen
I'm pretty confident I can replace all of this with some light tweaks to ~tab-bar-mode~ (e.g. turn off the tab bar, make an easy way to show the current tabs in the echo area, etc).
